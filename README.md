...
```javascript
meanpn = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-meanpn@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-strided-meanpn/tags). For example,

```javascript
meanpn = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-meanpn@v0.1.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var meanpn = require( 'path/to/vendor/umd/stats-strided-meanpn/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-meanpn@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-strided-meanpn.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-strided-meanpn

[test-image]: https://github.com/stdlib-js/stats-strided-meanpn/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/stats-strided-meanpn/actions/workflows/test.yml?query=branch:v0.1.1

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-strided-meanpn/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-strided-meanpn?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-strided-meanpn.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-strided-meanpn/main
...
[branches-url]: https://github.com/stdlib-js/stats-strided-meanpn/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-strided-meanpn/main/LICENSE
